    ...
    <body>
        <div class="container">
            <form action="usuario.php" method="post">
                ...
                <br>
                <div class="form-group">
                    <label for="senha_conf_usuario">Confirme a senha</label>
                    <input required type="password" class="form-control" id="senha_conf_usuario" name="senha_conf_usuario" placeholder="Confirme a senha do usuário">
                </div>
                <br>
